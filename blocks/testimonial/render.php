...
$block_id = 'testimonial-' . wp_rand(1000, 9999);
?>

<div class="py-16 px-4 bg-gray-50">
    <div class="container mx-auto">
        <div class="swiper <?php echo esc_attr($block_id); ?>">
                    ...
                    <div class="swiper-slide">
                        <div class="bg-white rounded-lg shadow-xl p-8 max-w-3xl mx-auto">
                            <div class="flex items-center mb-6">
                                ...
                                <div>
                                    <h4 class="font-bold text-xl"><?php echo esc_html($testimonial['name']); ?></h4>
                                    <p class="text-gray-600"><?php echo esc_html($testimonial['role']); ?></p>
                                    <div class="flex mt-1">
                                        <?php for ($i = 0; $i < 5; $i++) : ?>
